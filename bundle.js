...
/***/ (function(module, exports, __webpack_require__) {
	...
	_vue2.default.use(_vueRouter2.default); //明确地安装路由模块
	// 1. 定义（路由）组件。
	// 可以从其他文件 import 进来
...
/***/ (function(module, exports, __webpack_require__) {
	...
	Component.options.__file = "/Users/shuai/quxuecheH5/webpack-vue-master/src/index/App.vue"
	...
	if (false) {(function () {
	  ...
	  module.hot.accept()
	  if (!module.hot.data) {
	    hotAPI.createRecord("data-v-5faa3b7e", Component.options)
	  } else {
	    hotAPI.reload("data-v-5faa3b7e", Component.options)
	  }
	})()}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var update = __webpack_require__(8)("044fcce1", content, false);
	// Hot Module Replacement
	if(false) {
	 // When the styles change, update the <style> tags
	 if(!content.locals) {
	   module.hot.accept("!!../../node_modules/css-loader/index.js!../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-5faa3b7e&scoped=true!../../node_modules/sass-loader/index.js!../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./App.vue", function() {
	     var newContent = require("!!../../node_modules/css-loader/index.js!../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-5faa3b7e&scoped=true!../../node_modules/sass-loader/index.js!../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./App.vue");
...
/***/ (function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "\n.router-fade-enter-active[data-v-5faa3b7e], .router-fade-leave-active[data-v-5faa3b7e] {\n  transition: opacity .3s;\n}\n.router-fade-enter[data-v-5faa3b7e], .router-fade-leave-active[data-v-5faa3b7e] {\n  opacity: 0;\n}\n", ""]);
...
/***/ (function(module, exports) {
	...
	exports.default = {
		...
		created: function created() {
			this.checkLogin(); //主入口进来验证登录
		},

		methods: {
			checkLogin: function checkLogin() {
				var sessions = localStorage.getItem("appsession");
				if (sessions != "goxuecheapp") {

					// this.$router.push('/login');// 在使用了 vue-router 的应用中,路由对象会被注入每个组件中,赋值为 this.$route ,并且当路由切换时,路由对象会被更新
				}
			}
		}
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	if (false) {
	  module.hot.accept()
	  if (module.hot.data) {
	     require("vue-hot-reload-api").rerender("data-v-5faa3b7e", module.exports)
	  }
	}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	Component.options.__file = "/Users/shuai/quxuecheH5/webpack-vue-master/src/components/a.vue"
	if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
	...
	if (false) {(function () {
	  ...
	  module.hot.accept()
	  if (!module.hot.data) {
	    hotAPI.createRecord("data-v-314a7c8a", Component.options)
	  } else {
	    hotAPI.reload("data-v-314a7c8a", Component.options)
	  }
	})()}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	if(content.locals) module.exports = content.locals;
	// add the styles to the DOM
	var update = __webpack_require__(8)("01a91dca", content, false);
	// Hot Module Replacement
	if(false) {
	 // When the styles change, update the <style> tags
	 if(!content.locals) {
	   module.hot.accept("!!../../node_modules/css-loader/index.js!../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-314a7c8a!../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./a.vue", function() {
	     var newContent = require("!!../../node_modules/css-loader/index.js!../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-314a7c8a!../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./a.vue");
	     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
	     update(newContent);
	   });
	 }
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('div', [_vm._v("It is a webpack-demo!!!")])
	},staticRenderFns: []}
	module.exports.render._withStripped = true
	if (false) {
	  module.hot.accept()
	  if (module.hot.data) {
	     require("vue-hot-reload-api").rerender("data-v-314a7c8a", module.exports)
	  }
	}
...
/***/ (function(module, exports) {
	...
	(function () {
		...
		GXC = {
			...
			typeof: function _typeof(obj) {
				...
				return (typeof obj === "undefined" ? "undefined" : _typeof2(obj)) === "object" || typeof obj === "function" ? typeobj[typeobj.toString.call(obj)] || "object" : typeof obj === "undefined" ? "undefined" : _typeof2(obj);
			},
			isphone: function isphone(phonenum) {
				var isphones = /^1\d{10}$/gi.test(phonenum);
				return isphones;
			},
			//获取cookies的函数
			getCookieFunc: function getCookieFunc(c_name) {
			...
			//离线存储sessionStorage
			sessionStore: function sessionStore(namespace, data) {
				if (data || data == "") {
			...
			clearStorage: function clearStorage(namespace, type) {
				if (type == 0) {
			...
			//jsAppend
			scriptAppend: function scriptAppend(jsurl, callback) {
			...
			domAppend: function domAppend(obj) {
	...
	(function () {
		scheme = {
			...
			openview: function openview(url, callback) {
